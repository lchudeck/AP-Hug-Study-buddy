...
(function(){
  ...
  function load(){try{return JSON.parse(window.APStudyReliability.storage.getItem(STORE)||'{"topics":{},"misconceptions":{},"frq":{}}')}catch(e){return {topics:{},misconceptions:{},frq:{}}}}
  ...
  function targetTopic(){
    ...
    try{const ts=JSON.parse(window.APStudyReliability.storage.getItem(TOPIC_STORE)||'{}').topics||{};const k=Object.keys(ts)[0];if(k)return k;}catch(e){}
    return '2.5';
  }
