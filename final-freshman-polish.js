(()=>{
  ...
  const mapInfo={
    ...
    isoline:{title:'Isoline map',notice:'Instructional schematic: lines connect places with equal values.',use:'Continuous data such as elevation, temperature, pressure, or precipitation.',limit:'Values between lines are estimated; close lines can be hard to read.',ap:'Closer lines usually mean a faster change across space.'},
    cartogram:{title:'Cartogram',notice:'Instructional schematic: areas are intentionally resized by a variable.',use:'Making magnitude visually obvious, such as population or GDP.',limit:'Distortion makes exact location, shape, and distance harder to interpret.',ap:'Do not mistake resized area for actual land area.'}
  };
