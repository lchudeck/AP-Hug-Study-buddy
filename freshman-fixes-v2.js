(function(){
  ...
  if(typeof getMasterySnapshot==='function'){
    ...
    getMasterySnapshot=function(){
      ...
      try{
        const legacy=JSON.parse(window.APHGSafeStorage.getItem('aphgPracticeMasteryV4')||'{}');
        ...
        const review=JSON.parse(window.APHGSafeStorage.getItem('aphgUnitReviewProgressV1')||'{"attempted":0,"correct":0}');
