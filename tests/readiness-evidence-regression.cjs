...
const tracker=fs.readFileSync('session-rating.js','utf8'),home=fs.readFileSync('app.js','utf8');
...
assert.match(home,/Building evidence/);assert.match(home,/snap\.attempted>=10/);assert.match(home,/does not turn limited practice into a precise “ready” percentage/);assert.match(home,/This is a quick snapshot, not a grade/);
